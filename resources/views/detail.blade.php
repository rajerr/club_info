...
<body>
                ...
                <div class="col-md-12">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="index-2.html">
                            <img class="img-responsive" width="170px" src="{{asset('images/logo.png')}}" alt="logo">
                        </a>                    
                    </div><!--/ Logo end -->
    ...
    <div id="inner-header">
      <img src="{{asset('image/images3.jpg')}}" alt ="" />
    </div>
    <!-- Subpage title end -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                            <a id="back-to-top" href="#" class="scroll-up back-to-top" role="button" title="Click to return on the top page" data-toggle="tooltip" data-placement="left">
                                <img class="wow flipInY animated" width="200px"  src="{{asset('image/logo.png')}}" alt="">
                            </a>
                        </div>
